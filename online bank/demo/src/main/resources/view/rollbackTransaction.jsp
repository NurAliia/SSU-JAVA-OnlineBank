    ...
    <div class="info cnt-elem div-style">
        <form action="/rollback" method="post">
            <table>
                ...
                <th>Bank account target</th>
                <th>Transfer date</th>
                <th>Transfer value</th>
                <th>Transfer marker</th>
                <th><input type="submit" value="Rollback"/></th>
                </thead>
                <tbody>
                <c:forEach items="${operations}" var="oper">
                    <tr>
                        <td><c:out value="${oper.id}"/></td>
                        <td><c:out value="${oper.source.id}"/></td>
                        <td><c:out value="${oper.target}"/></td>
                        <td><c:out value="${oper.date}"/></td>
                        <td><c:out value="${oper.sum}"/></td>
                        <td><c:out value="${oper.marker}"/></td>
                        <td><input type="checkbox" name="checkbox_id" value="${oper.id}"></td>
                    </tr>
                </c:forEach>
                </tbody>
